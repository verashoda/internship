...
#top_labels = ['bad','action','design','info','com','game','good<br>move','quest','req']
#colors = ['rgb(214, 12, 140)','rgb(0, 128, 128)','rgb(10, 140, 208)','rgb(12, 102, 14)','rgb(10, 0, 100)','rgb(100, 0, 10)','rgb(255, 144, 14)','rgb(7,40,89)','rgb(255, 65, 54)'] #'rgb(222, 223, 0)'
